...
export default function DashboardPage() {
    ...
    const achievements = [
        ...
        { title: 'Speed Reader', subtitle: 'Read 50 pages in 1 session', icon: Medal, color: 'text-muted-foreground' },
        { title: 'Consistent Learner', subtitle: 'Studied every day this week', icon: Calendar, color: 'text-muted-foreground' }
    ];
            ...
            <div className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="bg-[#0f0f12] border border-border/60 rounded-xl p-5 flex flex-col justify-between h-32 hover:border-zinc-700/80 transition-colors">
                        ...
                        <p className="text-xs text-muted-foreground font-medium">Keep it up!</p>
                    </div>
                    ...
                    <div className="bg-[#0f0f12] border border-border/60 rounded-xl p-5 flex flex-col justify-between h-32 hover:border-zinc-700/80 transition-colors">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-xs uppercase tracking-wider font-semibold">This Week</p>
                            </div>
                        </div>
                    ...
                    <div className="bg-[#0f0f12] border border-border/60 rounded-xl p-5 flex flex-col justify-between h-32 hover:border-zinc-700/80 transition-colors">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-xs uppercase tracking-wider font-semibold">Completed</p>
                            </div>
                        </div>
                        <p className="text-xs text-muted-foreground font-medium">Books finished</p>
                    </div>
                    ...
                    <div className="bg-[#0f0f12] border border-border/60 rounded-xl p-5 flex flex-col justify-between h-32 hover:border-zinc-700/80 transition-colors">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-muted-foreground text-xs uppercase tracking-wider font-semibold">Pages/Hour</p>
                            </div>
                        </div>
                        <p className="text-xs text-muted-foreground font-medium">Reading speed</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-[#0f0f12] border border-border/60 rounded-xl p-6">
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-xs font-medium text-muted-foreground">Total: 847 minutes this week</p>
                    </div>
                </div>
