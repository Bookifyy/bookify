                ...
                <div className="overflow-x-auto">
                    <table className="w-full text-left">
                        ...
                        <tbody className="divide-y divide-zinc-800">
                            {loading ? (
                                <tr><td colSpan={4} className="p-8 text-center text-muted-foreground">Loading books...</td></tr>
                                    ...
                                    <tr key={book.id} className="group hover:bg-muted/30 transition-colors">
                                        ...
                                        <td className="p-4">
                                            {book.is_premium ? (
                                                ...
                                                <span className="inline-flex items-center gap-1.5 px-2 py-1 rounded text-xs font-medium bg-zinc-700/50 text-muted-foreground ring-1 ring-zinc-700">
                                                    Free
                                                </span>
                                            )}
                                        </td>
