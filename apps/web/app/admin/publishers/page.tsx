        ...
        <div className="space-y-6">
                ...
                <div className="flex flex-col md:flex-row gap-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="bg-card border border-border rounded-xl pl-10 pr-4 py-2.5 text-sm text-foreground focus:ring-2 focus:ring-indigo-600 outline-none w-full md:w-64 shadow-sm hover:shadow-md dark:shadow-none transition-shadow duration-300"
                            value={searchTerm}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {filteredPublishers.map((publisher) => (
                    <div key={publisher.id} className="bg-card border border-border rounded-2xl p-6 group hover:border-zinc-700 transition-all shadow-sm hover:shadow-md dark:shadow-none transition-shadow duration-300">
                        ...
                        <div className="flex items-center justify-between pt-4 border-t border-border">
                            ...
                            <div className="text-xs">
                                ...
                                <span className={`font-bold ${publisher.status === 'Active' ? 'text-green-500' : 'text-muted-foreground'}`}>
                                    {publisher.status}
                                </span>
                            </div>
