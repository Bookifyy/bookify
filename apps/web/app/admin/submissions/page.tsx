    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h1 className="text-3xl font-bold font-serif text-foreground">Quiz Submissions</h1>
            </div>
            ...
            <div className="bg-card border border-border p-4 rounded-xl flex flex-col md:flex-row gap-4 items-center justify-between">
                <div className="relative w-full md:w-96">
                    ...
                    <input
                        ...
                        className="w-full bg-background border border-zinc-700 text-foreground pl-10 pr-4 py-2 rounded-lg focus:outline-none focus:border-indigo-500"
                    />
                </div>
                ...
                <div className="flex items-center gap-2">
                    ...
                    <select
                        ...
                        className="bg-background border border-zinc-700 text-foreground px-4 py-2 rounded-lg focus:outline-none focus:border-indigo-500"
                    >
                            ...
                            filteredAttempts.map((attempt) => (
                                <tr key={attempt.id} className="hover:bg-muted/50 transition-colors">
                                    <td className="px-6 py-4">
                                        <div className="font-medium text-foreground">{attempt.user.name}</div>
                                        <div className="text-xs text-muted-foreground">{attempt.user.email}</div>
                                    </td>
                                    <td className="px-6 py-4">
                                        <div className="text-foreground">{attempt.quiz.title}</div>
                                        {attempt.quiz.book && (
