    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-background/80 backdrop-blur-sm">
            <div className="bg-card border border-border rounded-2xl w-full max-w-sm shadow-2xl p-6">
                <h2 className="text-xl font-bold text-foreground mb-2">Collection Invitation</h2>
                <p className="text-muted-foreground mb-6">
                    <span className="text-foreground font-semibold">{invitedBy}</span> invited you to view the collection <span className="text-[#0ea5e9] font-semibold">{collectionName}</span>.
                </p>
                ...
                <div className="flex gap-3">
                    ...
                    <button
                        ...
                        disabled={loading}
                        className="flex-1 py-3 bg-[#0ea5e9] hover:bg-sky-400 text-foreground rounded-xl font-bold transition-colors flex items-center justify-center gap-2 shadow-sm"
                    >
